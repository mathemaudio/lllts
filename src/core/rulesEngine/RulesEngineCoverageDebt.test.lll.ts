...
export class RulesEngineCoverageDebtTest {
	...
	static async fullCoverageMapsToZeroDebt(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
	...
	static async ninetySixCoverageNotice(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
	...
	static async ninetyFiveCoverageWarningBoundary(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
	...
	static async ninetyCoverageWarning(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
	...
	static async eightyFiveCoverageAlertBand(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
	...
	static async eightyCoverageErrorBoundary(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
	...
	static async seventyCoverageOverHundredDebt(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
	...
	static async zeroClassesStatus(input: object = {}, assert: AssertFn, waitFor: WaitForFn) {
